...
export default function ProfilePage({
  ...
  const qualificationLevels: QualificationLevel[] = [{
    ...
    level: 'Level 3',
    limit: '$10,000',
    requirements: ['Upload legal document (any of the following):', '• Property Document', '• Car Document', '• Marriage Certificate', '• Police Clearance Certificate', '• School/University Certificate', '• Utility Bill'],
    ...
    level: 'Level 5',
    limit: '$1,000,000',
    requirements: ['Business only - Upload business certificate', 'Provide Social Security or TIN'],
                ...
                <div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div className="p-4 bg-gray-50 rounded-lg border border-gray-200">
                      ...
                      <p className="text-lg font-semibold text-gray-900 capitalize">{userType}</p>
                    </div>
                    <div className="p-4 bg-gray-50 rounded-lg border border-gray-200">
