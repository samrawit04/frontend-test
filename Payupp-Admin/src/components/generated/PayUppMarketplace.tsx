              ...
              <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="lg:hidden space-y-8">
                  ...
                  <div className="text-center lg:text-left">
                    <p className="text-lg sm:text-xl font-bold text-blue-600 mb-4 sm:mb-6">
                      Peer-to-Peer International Money Transfer
                    </p>
                ...
                <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-6 sm:gap-8">
                  ...
                  <div className="flex gap-4 sm:col-span-2 md:col-span-1">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-600">
                        Every agent passes our 6-point verification process.
                      </p>
                    </div>
                  </div>
                </div>
            ...
            <section className="bg-gradient-to-br from-blue-50 to-white py-12 sm:py-16">
              <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                ...
                <p className="text-base sm:text-lg md:text-xl text-gray-600 mb-5 sm:mb-6">
                  Send money abroad in 4 simple steps. No complexity, just fast and secure transfers.
                </p>
              ...
              <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="space-y-4 sm:space-y-5">
                  ...
                  <div className="bg-white rounded-xl border border-gray-200 p-5 sm:p-6">
                    ...
                    <p className="text-gray-600 text-sm sm:text-base leading-relaxed">
                      All agents undergo a comprehensive 6-point verification process including identity verification, payment method verification, background checks, and compliance screening. We continuously monitor agent performance and user ratings.
                    </p>
                  </div>
            ...
            <div className="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-4 gap-6 sm:gap-8">
              <div className="col-span-2 sm:col-span-2 md:col-span-1">
                ...
                <p className="text-gray-400 text-sm">
                  Secure cross-border transfers through verified local agents.
                </p>
              </div>
              <div>
